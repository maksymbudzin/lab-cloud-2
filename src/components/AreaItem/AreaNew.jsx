        ...
        <div style={{}}>
            ...
            <div className="main-section-secret-second"
                 style={{
                     ...
                     alignItems: "center",
                     backgroundImage: `url("https://prd-webrepository.firabarcelona.com/wp-content/uploads/sites/9/2019/07/08084955/20190422.jpg")`,
                     paddingTop: "60px"
                 }}>
                ...
                <span style={{
                    ...
                    fontWeight: "900",
                    background: 'rgba(255, 255, 255, 0.7)'
                }}> Enter lighting with reference to geolocation</span>
...
async function SaveArea(timestamp, sensor_id, sensor_type, location, humidity, lux, apiKey) {
    ...
    axios.post(`http://makslviv.xyz:80/api/`, {body})
